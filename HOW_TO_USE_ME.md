...
| **Large sample data committed to git** | bundled result JSONs | **Low** | Bloats the repo over time | Move sample data out of git or into a `samples/` dir; keep one small example |
